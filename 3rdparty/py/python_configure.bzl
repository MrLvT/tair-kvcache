...
# modified from https://github.com/OpenMined/PSI/blob/master/private_set_intersection/python/extensions.bzl
...
def _get_python_platform(rctx, python_bin):
    check_cmd = [python_bin, "-c", "import packaging; print(packaging.__version__)"]
...
declare_python_platform = repository_rule(
    doc = """Make variable tags to pass to a py_wheel rule.""",
